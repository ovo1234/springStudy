...
import com.example.cloneboard.Service.CustomUserDetailService;
import com.example.cloneboard.Service.RedisService;
...
public class JwtTokenProvider {
    ...
    // Access Token 생성.
    public String createAccessToken(String email,  Role userRole) {
        return this.createToken(email, userRole, accessTokenValidTime);
    }
    // Refresh Token 생성.
    public String createRefreshToken(String email, Role userRole) {
        return this.createToken(email, userRole, refreshTokenValidTime);
    }

    // Create token
    public String createToken(String email, Role userRole, long tokenValid) {
    ...
    public String reissueAccessToken(String refreshToken) {
        ...
        return createAccessToken(email, userRepository.findByEmail(email).getRole());
    }
